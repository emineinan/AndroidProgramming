...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        painterNameText=findViewById(R.id.artistnameText);
        ...
        if(info.matches("new")){
          ...
          try{
              ...
              while(cursor.moveToNext()){
                  ...
                  Bitmap bitmap=BitmapFactory.decodeByteArray(bytes,0,bytes.length);//this code converts the byte array to image.
